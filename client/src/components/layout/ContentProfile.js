...
const ContentProfile = () => {
  return (
    <ContentProfileStyle>
      <div className="pl-[24px] pr-[24px] pt-[32px] pb-[32px]">
        <div className="flex flex-row">
          <div className="flex flex-row w-[540px]">
            <img
            ...
            <div className="ml-[20px]">
              ...
              <button className="mt-[16px] flex flex-row justify-start items-center pl-[16px] pr-[16px] border border-[#f1f1f8] rounded-sm min-h-[36px] select-none">
                <svg
        ...
        <div className="mt-[20px]">
          <div className="flex flex-row mb-2">
            <span className="text-li">3 Following</span>
            <span className="ml-3 mr-3 text-li">1 Followers</span>
            <span className="text-li">0 Likes</span>
          </div>
          <span>Đi lên từ IT</span>
        </div>
      </div>
      <div></div>
    </ContentProfileStyle>
